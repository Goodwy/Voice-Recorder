...
import dev.goodwy.voicerecorder.databinding.FragmentRecorderBinding
import dev.goodwy.voicerecorder.extensions.config
import dev.goodwy.voicerecorder.extensions.ensureStoragePermission
import dev.goodwy.voicerecorder.extensions.setKeepScreenAwake
...
//            setImageResource(R.drawable.ic_record_animated)
        ...
        binding.recordingControlsWrapper.setBackgroundColor(context.getSurfaceColor())
    }
