package dev.goodwy.voicerecorder.fragments
...
import dev.goodwy.voicerecorder.adapters.RecordingsAdapter
import dev.goodwy.voicerecorder.databinding.FragmentPlayerBinding
...
import dev.goodwy.voicerecorder.receivers.BecomingNoisyReceiver
...
class PlayerFragment(
    ...
    private fun getProgressUpdateTask() = object : TimerTask() {
        override fun run() {
            Handler(Looper.getMainLooper()).post {
                if (player != null) {
                    val progress = (player!!.currentPosition / 1000.toDouble()).roundToInt()
    ...
    private fun setupColors() {
        ...
        if (context.config.roundIcon) {
            ...
            binding.playPauseBtn.background.applyColorFilter(context.getSurfaceColor())
        ...
        binding.playerControlsWrapper.setBackgroundColor(context.getSurfaceColor())
    }
